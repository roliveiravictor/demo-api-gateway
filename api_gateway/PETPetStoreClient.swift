...
public class PETPetStoreClient: AWSAPIGatewayClient {

	static let AWSInfoClientKey = "PETPetStoreClient"

	private static let _serviceClients = AWSSynchronizedMutableDictionary()
	private static let _defaultClient:PETPetStoreClient = {
        ...
        return PETPetStoreClient(configuration: serviceConfiguration!)
	}()
	...
	/**
	 ...
	 Then call the following to get the default service client:
	     ...
	     let serviceClient = PETPetStoreClient.default()

     Alternatively, this configuration could also be set in the `info.plist` file of your app under `AWS` dictionary with a configuration dictionary by name `PETPetStoreClient`.
	
	 @return The default service client.
	 */ 
	 
	public class func `default`() -> PETPetStoreClient{
	...
	/**
	 ...
	 If you want to enable AWS Signature, set the default service configuration in `func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?)`
	     ...
	     func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?) -> Bool {
	         ...
	         PETPetStoreClient.registerClient(withConfiguration: configuration, forKey: "USWest2PETPetStoreClient")
	 ...
	 Then call the following to get the service client:
	     ...
	     let serviceClient = PETPetStoreClient.client(forKey: "USWest2PETPetStoreClient")
	...
	public class func registerClient(withConfiguration configuration: AWSServiceConfiguration, forKey key: String){
		_serviceClients.setObject(PETPetStoreClient(configuration: configuration), forKey: key  as NSString);
	}
	 ...
	 */
	public class func client(forKey key: String) -> PETPetStoreClient {
		objc_sync_enter(self)
		if let client: PETPetStoreClient = _serviceClients.object(forKey: key) as? PETPetStoreClient {
			objc_sync_exit(self)
		    return client
		}
		...
		if let serviceInfo = serviceInfo {
			...
			PETPetStoreClient.registerClient(withConfiguration: serviceConfiguration!, forKey: key)
		}
		objc_sync_exit(self)
		return _serviceClients.object(forKey: key) as! PETPetStoreClient;
	}
	...
	init(configuration: AWSServiceConfiguration) {
	    ...
	    var URLString: String = "https://30nwnnxgri.execute-api.us-east-1.amazonaws.com/example"
    ...
    /*
     ...
     return type: PETPets
     */
    public func petsGet(type: String?, page: String?) -> AWSTask<PETPets> {
	    let headerParameters = [
                   "Content-Type": "application/json",
                   "Accept": "application/json",
	    ...
	    return self.invokeHTTPRequest("GET", urlString: "/pets", pathParameters: pathParameters, queryParameters: queryParameters, headerParameters: headerParameters, body: nil, responseClass: PETPets.self) as! AWSTask<PETPets>
	}
    ...
    /*
     ...
     return type: PETNewPetResponse
     */
    public func petsPost(body: PETNewPet) -> AWSTask<PETNewPetResponse> {
	    let headerParameters = [
                   "Content-Type": "application/json",
                   "Accept": "application/json",
	    ...
	    return self.invokeHTTPRequest("POST", urlString: "/pets", pathParameters: pathParameters, queryParameters: queryParameters, headerParameters: headerParameters, body: body, responseClass: PETNewPetResponse.self) as! AWSTask<PETNewPetResponse>
	}
    ...
    /*
     ...
     return type: PETPet
     */
    public func petsPetIdGet(petId: String) -> AWSTask<PETPet> {
	    let headerParameters = [
                   "Content-Type": "application/json",
                   "Accept": "application/json",
	    ...
	    return self.invokeHTTPRequest("GET", urlString: "/pets/{petId}", pathParameters: pathParameters, queryParameters: queryParameters, headerParameters: headerParameters, body: nil, responseClass: PETPet.self) as! AWSTask<PETPet>
	}
